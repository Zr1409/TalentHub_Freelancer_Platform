...
const Appointment = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const appointmentData = {
      startTime: selectedDate.toLocaleString('sv-SE').replace(' ', 'T'),
      duration: parseInt(formData.duration),
      topic: formData.topic,
      type: appointmentType, // "online" hoặc "offline"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Họp trực tiếp</h3>
                    <p className="text-sm text-muted-foreground">
          ...
          <FadeInWhenVisible delay={0.2}>
            <Card className="p-8">
              <form className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <Clock
                            className="absolute left-3 top-3 h-4 w-4 text-muted-foreground dark:text-white cursor-pointer"
                            onClick={() => {
                ...
                {/* Submit Button */}
                <Button onClick={handleSubmit} type="submit" className="w-full hover:bg-primary-700">
                  Xác nhận đặt lịch
                </Button>
              </form>
            </Card>
