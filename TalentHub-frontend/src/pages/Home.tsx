...
const BenefitCard = ({
  ...
  <FadeInWhenVisible delay={delay}>
    <div className="text-center group p-6 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
      ...
      <h3 className="text-xl font-semibold mb-4 text-primary-700 dark:text-gray-300">{title}</h3>
...
const Home = () => {
  ...
  return (
    <main className="relative">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <FadeInWhenVisible delay={0.4}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                  className="text-lg bg-primary hover:bg-primary-700"
                  onClick={() =>
                    isLoggedIn
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg border-primary text-primary hover:bg-primary-100 hover:text-primary dark:text-white "
                  onClick={() =>
      ...
      <section className="py-10" id="statistics-section">
        <div className="container mx-auto px-4">
      ...
      {/* Jobs Premium */}
      <section className="py-10" id="top-jobs">
        <div className="container mx-auto px-6">
          <FadeInWhenVisible>
            <h2 className="text-4xl font-extrabold text-center mb-10 bg-gradient-to-r dark:text-gray-300 from-primary-600 to-primary-800 bg-clip-text text-transparent dark:from-primary-400 dark:to-primary-600 py-2">
              Top Dự Án Nổi Bật
            </h2>
          </FadeInWhenVisible>
          {loadingJobs ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {jobsPremium?.map((job, index) => (
                <FadeInWhenVisible key={job.id} delay={index * 0.15}>
                  <Card
                    className="relative p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden group flex flex-col h-full"
                    style={{ height: "100%" }}>                   
      ...
      {userInfo && userInfo.clientId ? (
        <section
          ...
          <div className="container mx-auto px-6">
            <FadeInWhenVisible>
              <h2 className="text-4xl font-extrabold text-center mb-10 dark:text-gray-300 bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent dark:from-primary-400 dark:to-primary-600 py-2">
                      ...
                      <div className="flex items-start gap-4 h-full">
                        ...
                        <div className="flex-1 flex flex-col h-full">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            >
                              <Button variant="outline" size="sm" className="text-blue-600 dark:bg-gray-800 dark:text-white border-blue-600 dark:hover:bg-primary-700 hover:bg-primary-700 hover:text-white">
                                Xem hồ sơ
                              </Button>
                            </Link>
                          </div>
        ...
        >
          <div className="container mx-auto px-6">
            <FadeInWhenVisible>
              <h2 className="text-4xl font-extrabold text-center mb-6 text-gray-800 bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent py-4">
            ...
            <div className="text-center space-y-6">
              ...
              <Button
                ...
                className="bg-primary-500 dark:bg-primary-500 hover:bg-primary-600 dark:hover:bg-primary-800 text-white"
              >
                Bắt đầu đăng việc để được gợi ý
              </Button>
            </div>
      ...
      <section className="py-10" id="explore-projects">
        <div className="container mx-auto px-4">
          <FadeInWhenVisible>
            <h2 className="text-4xl font-extrabold text-center mb-10 text-gray-800 dark:text-gray-300 bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent dark:from-primary-400 dark:to-primary-600 py-2">
      ...
      <section className="py-10" id="features">
        <div className="container mx-auto px-4">
          <FadeInWhenVisible>
            <h2 className="text-3xl font-bold text-center dark:text-gray-300 mb-10 text-primary-800">
              Đặc điểm nổi bật
            </h2>
          </FadeInWhenVisible>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
            <BenefitCard className="dark:text-gray-300"
              Icon={Users}
      ...
      >
        <div className="container relative mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto">
            <FadeInWhenVisible>
              <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent py-2">
            ...
            <FadeInWhenVisible delay={0.4}>
              <Button
                size="lg"
                className="text-lg bg-gradient-to-r from-primary-500 to-primary-500 text-white hover:from-primary-600 hover:to-primary-800 shadow-lg hover:shadow-xl transition-all duration-300"
      ...
      <section className="py-10" id="trusted-companies">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10 text-primary-800 dark:text-gray-300">
          ...
          {customers.length > 3 && (
            <div className="text-center mt-8">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-2 bg-gray-100 hover:bg-gray-300 text-gray-700 rounded-full transition-colors duration-300 font-medium"
