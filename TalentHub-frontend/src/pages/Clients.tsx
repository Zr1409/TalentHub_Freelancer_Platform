...
import { Star, MapPin, Search, Filter, X, Building } from "lucide-react";
                  ...
                  <div className="flex items-start gap-4 h-full">
                    ...
                    <div className="flex-1 flex flex-col h-full">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="outline" size="sm" className="text-blue-600 border-blue-600 hover:bg-primary-700 hover:text-white">
