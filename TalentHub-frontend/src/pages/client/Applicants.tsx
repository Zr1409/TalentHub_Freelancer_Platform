                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button                        
                                ...
                                className="text-blue-600 border-primary-300"
                              >
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                variant="outline"
                                className="text-green-600 border-primary-300"
                              >
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                className="text-red-600 border-primary-300"
                              >
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                className="text-yellow-600 border-primary-300"
                              >
