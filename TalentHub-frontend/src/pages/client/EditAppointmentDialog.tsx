...
const formatDateForVietnamese = (date: Date) => {
        ...
        <div className="relative w-full" ref={calendarRef}>
            <button
                ...
                className={cn(
                    ...
                    "hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                )}
            ...
            {showCalendar && (
                <div className="absolute z-50 mt-1 w-full dark:bg-gray-900 bg-white border border-gray-200 rounded-md shadow-lg p-3">
                    ...
                    <div className="grid grid-cols-7 mb-1">
                        {['CN', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7'].map((day, index) => (
                            <div key={index} className="text-center text-xs font-medium text-white py-1">
                                {day}
                            </div>
                        ))}
                    </div>
                        ...
                        {days.map((day, index) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    !day ? "text-gray-300" : "text-gray-500",
                                    isDisabled(day) && day ? "text-gray-300 cursor-not-allowed" : "",
                                    isToday(day) ? "border border-blue-300" : "",
                                    isSelected(day) ? "bg-blue-500 text-white hover:bg-blue-700" : "hover:bg-blue-100",
...
const EditAppointmentDialog = ({
        ...
        if (appointment && open) {
            try {
                ...
                setForm({
                    ...
                    type: (appointment as any).type || "ONLINE",
                });
                setDateError(false);
        ...
        return (
            <div className="flex space-x-2 items-center">
                ...
                <select
                    ...
                    className="rounded border border-gray-300 p-2 hover:bg-gray-50 bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-700"
                >
                    {hourOptions.map(h => (
                        <option className="dark:bg-gray-900" key={`hour-${h}`} value={h}>
                ...
                >
                    {minuteOptions.map(m => (
                        <option className="dark:bg-gray-900" key={`minute-${m}`} value={m}>
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Kiểm tra ngày giờ đã chọn phải sau thời điểm hiện tại
        const now = new Date();
        ...
        try {
            ...
            const data = {
                ...
                startTime: form.startTime.toLocaleString('sv-SE').replace(' ', 'T'),
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                    <div className="grid grid-cols-5 items-center gap-4">
                        <Label htmlFor="topic" className="ms-4 text-left">
                    ...
                    <div className="grid grid-cols-5 items-start gap-4">
                        <Label htmlFor="description" className="ms-4 text-left pt-2">
                            Mô tả
                        </Label>
                        <Textarea
                            id="description"
                    ...
                    <div className="flex items-center gap-4 ms-4">
                        <label className="text-sm font-medium min-w-max">Hình thức cuộc hẹn:</label>
                        <Select
                            value={form.type}
                            onValueChange={(value) =>
                                setForm((prev) => ({ ...prev, type: value as "ONLINE" | "OFFLINE" }))
                            }
                        >
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg border dark:bg-gray-600">
                        <h3 className="text-sm font-medium mb-3">Thời gian cuộc hẹn</h3>

                        <div className="grid grid-cols-4 items-center gap-4 mb-3">
                            <Label className="ms-4 text-left">
                                Ngày <span className="text-red-500">*</span>
                            </Label>
                            <div className="col-span-3 dark:hover:bg-gray-600">
                                <CustomDatePicker
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3 dark:bg-black-500">
                                <CustomTimeSelector />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg border dark:bg-gray-600">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4 mb-3">
                            ...
                            <Select
                                ...
                                required
                            >
                                <SelectTrigger className="col-span-3 hover:bg-gray-50">
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <div className="col-span-3 relative">
                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <LinkIcon className="h-4 w-4 text-gray-400 dark:text-white" />
                                    </div>
                                    <Input
                                        id="link"
                                        name="link"
                    ...
                    <DialogFooter className="pt-2">
                        <DialogClose asChild>
                            <Button type="button" variant="outline" className="border-primary-300">
                                Hủy
                            </Button>
                        </DialogClose>
                        <Button
