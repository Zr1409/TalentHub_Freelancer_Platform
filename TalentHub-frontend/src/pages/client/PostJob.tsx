                      ...
                      <Button
                        ...
                        className="w-full justify-between">
                        {
                          !jobData.scope ? "Chọn phạm vi"
                            : jobData.scope === "SMALL" ? "Nhỏ"
                              : jobData.scope === "MEDIUM" ? "Vừa"
                                : "Lớn"
                        }
                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                      </Button>
                      ...
                      <Command className="w-full">
                        <CommandList className="w-full">
                          {Object.values(ScopeJob).map((scope) => (
                            ...
                            >
                              <Check
                                className={`mr-2 h-4 w-4 ${jobData.scope === scope
                                    ? "opacity-100"
                                    : "opacity-0"
                                  }`}
                              />
                    ...
                    <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0">
                      <Command className="w-full">
                        <CommandList className="w-full">
                          ...
                          >
                            <Check
                              className={`mr-2 h-4 w-4 ${jobData.typePayment === TypePayment.HOURLY
                                  ? "opacity-100"
                                  : "opacity-0"
                                }`}
                            />
                          ...
                          >
                            <Check
                              className={`mr-2 h-4 w-4 ${jobData.typePayment === TypePayment.FULL
                                  ? "opacity-100"
                                  : "opacity-0"
                                }`}
                            />
                  ...
                  <CommandList>
                    ...
                    <CommandGroup>
                      {skills.map((skill) => (
                        ...
                        >
                          <Check
                            className={`mr-2 h-4 w-4 ${selectedSkills.includes(skill.id)
                                ? "opacity-100"
                                : "opacity-0"
                              }`}
                          />
