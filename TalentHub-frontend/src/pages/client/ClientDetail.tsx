                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <div
                          className={`text-sm px-3 py-1 rounded-full inline-flex items-center gap-1.5 ${user?.status === "Khoá"
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg dark:bg-background">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>
                            {client.ward} {client.ward != "" ? ", " : ""} {client.province}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-8">
                      {client.companies.map((company) => (
                        <div key={company.id} className="flex gap-6 group">
                          {/* Logo công ty */}
                          <div className="flex-shrink-0">
                            <Avatar className="w-32 h-32 rounded-md border border-gray-200 dark:border-gray-700">
                              <AvatarImage
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-gray-600 mt-2">
                              <div className="flex items-center">
                                <PackageCheck className="w-4 h-4 mr-2 text-gray-400" />Lĩnh vực:
                              ...
                              <div className="flex items-center">
                                ...
                                <span>Địa điểm: {company.address}</span>
                              </div>
                              <div className="flex items-center">
                                <Phone className="w-4 h-4 mr-2 text-gray-400" />
                                <span>Số điện thoại: {company.phoneContact}</span>
                              </div>
                            </div>
                          </div>
                        </div>
