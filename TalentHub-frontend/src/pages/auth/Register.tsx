...
import LocationSelector from "@/pages/freelancer/settings/LocationSelector";
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //  const status = formData.role === "FREELANCER" ? "Hoạt động" : "Không hoạt động";
    try {
            ...
            <Card className="p-8 shadow-lg border-opacity-50 backdrop-blur-sm bg-background/80">
              ...
              >
                <TabsList className="grid grid-cols-3 mb-8">
                  ...
                  >
                    <CheckCircle
                      className={`mr-2 h-4 w-4 ${activeTab !== "basicInfo" &&
                  ...
                  >
                    <CheckCircle
                      className={`mr-2 h-4 w-4 ${activeTab !== "personalInfo" &&
                        activeTab !== "professionalInfo"
                        ? "opacity-40"
                        : ""
                        }`}
                  ...
                  >
                    <CheckCircle
                      className={`mr-2 h-4 w-4 ${activeTab !== "professionalInfo" ? "opacity-40" : ""
                        }`}
                    />
                ...
                <TabsContent value="basicInfo">
                  <form className="space-y-5">
                    ...
                    <div className="space-y-3">
                      <div className="relative group">
                        <UserRoundCog className="absolute left-3 top-3 h-5 w-5 text-muted-foreground group-focus-within:text-primary transition-colors" />
                        <Select
                          value={formData.role}
                          onValueChange={(value) =>
                    ...
                    <div className="flex justify-end">
                      <Button
                        ...
                        className="h-12 px-6 text-base font-medium hover:bg-primary-700"
                      >
                        Tiếp theo
                ...
                <TabsContent value="professionalInfo">
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <Button
                        type="submit"
                        className="h-12 px-6 text-base font-medium bg-primary hover:bg-primary-700"
                        disabled={loading}
                      >
