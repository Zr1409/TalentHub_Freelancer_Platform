            ...
            <Card className="p-8 shadow-lg border-opacity-50 backdrop-blur-sm bg-background/80">
              ...
              {!showMfaForm ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    className="w-full h-12 text-base font-medium hover:bg-primary-700"
                    disabled={loading}
                  >
                ...
                <form onSubmit={handleMfaSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    className="w-full text-base font-medium hover:bg-primary-700"
                    disabled={loading}
                  >
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full mt-2 border-primary-300 hover:border-green-300"
