    ...
    <>
                      ...
                      <div className="flex flex-col flex-grow">
                        ...
                        <div className="mt-auto">
                          {(plan.typePackage !== "NORMAL" ||
                            plan.myPackage) && (
                            <Button
                              className="w-full border-blue-600 hover:bg-primary-700"
                              variant={
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="border-primary-300">Trở lại</AlertDialogCancel>
            <AlertDialogAction className="hover:bg-primary-700" onClick={confirmSubscribe}>
              Chắc chắn
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
