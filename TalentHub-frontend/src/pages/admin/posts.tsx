          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {selectedAction?.type === "ban"
                ? "Bạn có chắc chắn muốn khoá bài viết này?"
                : "Bạn có chắc chắn muốn mở khoá bài viết này?"}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-primary-300 hover:border-green-300">Hủy</AlertDialogCancel>
            <AlertDialogAction className=" hover:bg-primary-700" onClick={handleConfirm}>
              {selectedAction?.type === "ban" ? "Khoá" : "Mở khoá"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
                ...
                <div className="flex space-x-2">
                  {isBanned ? (
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="text-red-600 border-red-300 hover:border-green-300"
                    >
                      Khoá
                    </Button>
                  )}
