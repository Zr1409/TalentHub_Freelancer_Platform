...
const ChatbotManagement: React.FC = () => {
  ...
  const handleDeleteIntent = async () => {
    ...
    try {
      ...
      notification.success({
        message: "Thành công!",
        description: "Xoá ý định thành công!",
      });
      fetchIntents();
  ...
  const handleDeleteResponse = async () => {
    ...
    try {
      ...
      notification.success({
        message: "Thành công!",
        description: "Xoá phản hồi thành công!",
      });
      if (selectedIntent) {
        const updatedIntent = await fetchIntentDetails(selectedIntent.id);
        setSelectedIntent(updatedIntent);
      ...
      notification.error({
        message: "Error",
        description: "Failed to Xoá phản hồi",
      });
      console.error(error);
    }
  };
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button className="border-primary-300 hover:border-green-300" onClick={() => fetchStatistics()} variant="outline" size="sm">
              ...
              <CardContent>
                <div className="flex flex-col h-[500px]">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button className="hover:border-green-300 border-primary-300" variant="outline" onClick={resetChat}>
            ...
            <Card className="md:col-span-2">
              ...
              <CardContent>
                ...
                <div className="mt-4 flex justify-between">
                  <Button
                    className="hover:border-green-300 border-primary-300"
                    variant="outline"
                    size="sm"
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <Button
                            className="border-primary-300 hover:border-green-300"
                            variant="outline"
                            size="sm"
                            onClick={() => {
                              resetEditResponse();
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="hover:border-green-300 border-primary-300">Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={handleDeleteIntent}
              className="bg-destructive text-destructive-foreground bg-primary-500 hover:bg-primary-700 text-white"
            >
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Xoá phản hồi</AlertDialogTitle>
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xoá phản hồi này?{" "}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-primary-300 hover:border-green-300">Đóng</AlertDialogCancel>
            <AlertDialogAction
