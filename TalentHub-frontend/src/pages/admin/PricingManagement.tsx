...
export default function PricingManagement() {
    ...
    <div className="rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-sm border-collapse">
          <thead className="text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-800">
            <tr>
  ...
  const renderGridView = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {voucherPackages.map((pkg) => (
        <div key={pkg.id} className="rounded-lg p-6 border border-gray-200 dark:border-gray-800">
        ...
        <div className="flex items-center gap-2">
          <div className="rounded-lg p-1">
            <Button
              ...
              className="gap-2 border border-primary-300"
            >
          ...
          {/*<Button
            className="gap-2 hover:bg-primary-700"
