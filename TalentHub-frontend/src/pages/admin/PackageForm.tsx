...
const PackageForm = ({ data, onChange, onSubmit, onCancel, title, description, isSubmitting }: PackageFormProps) => (
  <form onSubmit={onSubmit}>
    ...
    <DialogFooter>
      <Button className="hover:border-green-300 border-primary-300" type="button" variant="outline" onClick={onCancel}>
        Hủy
      </Button>
      <Button className="hover:bg-primary-700" type="submit" disabled={isSubmitting}>
