        ...
        <FadeInWhenVisible key={cv.id} delay={index * 0.1}>
          <Card className="p-6">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/3 lg:w-1/4 mb-4 md:mb-0 md:pr-6">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-2">
                    <Button
                      variant="outline"
                      className="hover:bg-primary-700 bg-primary-500 text-white"
                    ...
                    <Button
                      variant="ghost"
                      className="text-red-500 bg-gray-100 hover:text-white hover:bg-red-500"
              ...
              <div className="w-full md:w-2/3 lg:w-3/4 bg-gray-50 rounded-lg overflow-hidden flex-1 border border-gray-200">
                {cvPreviews[cv.id] ? (
                  <div className="relative h-full">
                    ...
                    <div className="absolute top-14 right-4">
                      <Button
                        size="sm"
                        variant="secondary"
                        className="bg-primary-200 bg-opacity-70 hover:bg-opacity-100"
