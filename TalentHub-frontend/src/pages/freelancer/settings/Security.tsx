...
const Security = ({ onMfaStatusChange }: SecurityProps) => {
 ...
 useEffect(() => {
  ...
  const checkMfaStatus = async () => {
    try {
      ...
      // Đồng bộ state với component cha ngay khi load
      if (onMfaStatusChange) {
        onMfaStatusChange(isEnabled);
      }
    } catch (err) {
  ...
  checkMfaStatus();
}, [user?.email, onMfaStatusChange]); // Thêm onMfaStatusChange vào dependencies
    ...
    return (
      <div className="flex flex-col items-center space-y-6 py-4">
        ...
        {isMfaEnabled ? (
          ...
          <Button className="hover:bg-primary-700" onClick={handleStartSetup} disabled={isLoadingMfa}>
            {isLoadingMfa ? (
              <>
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                Đang xử lý...
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex justify-between pt-4">
          <Button className="border-primary-300" variant="outline" onClick={handleCancelSetup}>
            Hủy
          </Button>
          <Button className="hover:bg-primary-700" onClick={handleNextStep}>Tiếp tục</Button>
        </div>
      </div>
    );
  };
  ...
  const renderVerifyCodeStep = () => {
    return (
      <div className="space-y-6">
        ...
        <div className="flex justify-between pt-4">
          <Button className="border-primary-300" variant="outline" onClick={handlePreviousStep}>
            Quay lại
          </Button>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="sm:justify-between">
            <Button
              ...
              className="mt-2 sm:mt-0 border-primary-300"
            >
              Hủy
            </Button>
            <Button
              ...
              <CardContent>
                <form onSubmit={handlePasswordChange} className="space-y-6">
                  ...
                  <div className="flex items-center justify-end">
                    <Button className="hover:bg-primary-700" type="submit" disabled={loading}>
                      {loading ? (
                        <>
                          <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                          Đang cập nhật...
