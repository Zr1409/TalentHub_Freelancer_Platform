  ...
  const handleImageUpload = async (id, file) => {
    try {
      ...
      if (project && project.image) {
        imageUrl = await projectsService.updateImage(project.image, file, "talenthub_projects" );
      } else {
        imageUrl = await projectsService.uploadImage(file, "talenthub_projects");
      }
            ...
            <div className="flex items-start justify-between mb-6">
              ...
              <div className="flex space-x-2">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-red-500 border-red-300 bg-gray-100 hover:text-white hover:bg-red-500"
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    disabled={submitting}
                    className="flex-1 border border-primary-300 hover:bg-primary-700"
                  >
