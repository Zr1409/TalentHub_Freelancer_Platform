...
import { User, Atom, GraduationCap, FolderKanban, Shield, FileText, CircleCheck, CircleAlert } from 'lucide-react';
...
const Settings = () => {
  ...
  const calculateProfileCompletion = (
    ...
    const hasLocation = Boolean(profile?.province) && Boolean(profile?.ward);
