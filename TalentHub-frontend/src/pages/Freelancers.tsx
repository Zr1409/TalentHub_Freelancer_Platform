          ...
          <div className="max-w-2xl mx-auto">
            <FadeInWhenVisible delay={0.2}>
              <div className="flex gap-4">
                ...
                <Button onClick={applyFilters} className="hover:bg-primary-700">
                  ...
                  <SheetContent className="w-[400px] overflow-y-auto">
                    ...
                    <div className="py-6 space-y-6">
                      ...
                      <div className="flex gap-4 pt-4 ">
                        <Button onClick={applyFilters} className="flex-1 hover:bg-primary-700">
                          Áp dụng
                        </Button>
                        <Button className="border-primary-300" variant="outline" onClick={resetFilters}>
                          Đặt lại
                        </Button>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredFreelancers.map((freelancer, index) => (
              <FadeInWhenVisible key={freelancer.id} delay={0}>
                <Card className="p-6 h-full dark:bg-gray-800">
