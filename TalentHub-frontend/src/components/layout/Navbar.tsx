...
const Navbar = () => {
  ...
  const freelancerMenuItems = [
    { to: "/jobs", label: t("jobs"), icon: NotepadText },
    { to: "/saved-jobs", label: "Đã lưu", icon: Save },
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <Link to={settingsPath}>
            <DropdownMenuItem
              className="hover:bg-primary-100 focus:bg-primary-100"
    ...
    <nav className="sticky top-0 z-50 w-full border-b border-primary-100/20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center space-x-2 group ms-6">
            <img
              width={50}
              src="/favicon.png"
              alt="Favicon"
            ...
            {isLoggedIn ? (
              ...
              <>
                <Button
                  variant="outline"
                  asChild
                  className="border-blue-600 text-primary-500 hover:bg-primary-100 hover:text-primary dark:text-white"
                >
